...
$scope.login = function (username, password) {
  ...
  if (response.data == "invalid") {
    $scope.username = "";
    $scope.password = "";
          //$scope.validityStatus = "invalidTemp ng-invalid";
...
$scope.displaySingleUser = function (id) { 
  ...
  $scope.searchUser = function () {
    ...
    $http({
     method: 'post',
     url: '../unifyWeb/functions/manageMsgFunction.php?marker=sendMsg',
     data: fd,
     headers: {'Content-Type': undefined},
   }).then(function successCallback(response) { 
  ...
  $scope.lockAccount = function (userId) {
    ...
    $http({
     method: 'post',
     url: '../unifyWeb/functions/manageMsgFunction.php?marker=lockAccount',
     data: fd,
     headers: {'Content-Type': undefined},
   }).then(function successCallback(response) { 
    $('#loadingModal').modal('hide');
