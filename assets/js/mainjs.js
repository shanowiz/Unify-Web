...
manageData.controller("validateEvent", function ($scope, $filter,$http,$window,$document){
    ...
    $scope.upload = function () {
        ...
        fd.append('eventImage', $scope.eventName);
...
manageData.controller("validateDiscount", function ($scope, $filter,$http,$window,$document){
